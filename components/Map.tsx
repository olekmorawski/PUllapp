...
export const Map = ({
    ...
    const routeGeoJSON: GeoJSON.FeatureCollection<GeoJSON.LineString> | null =
    (routeCoordinates && routeCoordinates.length > 1) ? { // Ensure at least two points for a LineString
